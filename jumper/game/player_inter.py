#this is a player interaction, contains simple rules and greetings
...
print("Would you like to hear the rules of this game?")
...
if rules == "y":
  print(" ")
  print("RULES:")
  print("There is a jumper who has leapt out of an airplane, and is now using a parachute to get down.")
